...
/**
 * <p>
 * This example code demonstrates how to use the PiFace device interface for GPIO pin state control
 * and monitoring.
 * </p>
 *
...
public class PiFaceExample {
	...
	private static final Logger LOG = Logger.getLogger(PiFaceExample.class);
